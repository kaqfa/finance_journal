"""
Django settings for journal_invest project.
...
ROOT_URLCONF = 'journal_invest.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'journal_invest.context_processors.admin_menu',
            ],
        },
    },
]

WSGI_APPLICATION = 'journal_invest.wsgi.application'
...
# filepath: journal_invest/settings.py
